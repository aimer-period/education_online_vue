        ...
        <el-form label-width="120px">
            <el-form-item label="信息描述">
                ...
                <el-tag>
                    ...
                    <a :href="OSS_PATH + '/excel/demo.xlsx'">点击下载模版</a>
                </el-tag>
            </el-form-item>
            <el-form-item label="选择Excel">
                <el-upload ref="upload" :auto-upload="false" :on-success="fileUploadSuccess" :on-error="fileUploadError"
                    :disabled="importBtnDisabled" :limit="1" :action="BASE_API + '/eduservice/subject/addSubject'"
...
export default {
    ...
    data() {
        return {
            ...
            // OSS_PATH:process.env.VUE_APP_OSS_PATH, //OSS地址
